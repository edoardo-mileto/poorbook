...
<?php
        ...
        $u = Utente::CaricaUtente($_POST['user_update']);

        echo "<form action=\"./update_user.php\" method=\"POST\">";
        echo "<h3>Modifica utente</h3><br>";
        echo '<textarea class="post col-sm-12" rows="5" cols="50" name="name" placeholder="' . $u->name .'" style="resize: none;">' . $u->name .'</textarea><br>';
        echo '<textarea class="post col-sm-12" rows="5" cols="50" name="surname" placeholder="' . $u->surname .'" style="resize: none;">' . $u->surname .'</textarea><br>';
